...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=fms Demo Installer\n"
      else:
        line="OutputBaseFilename=fms Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the fms Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the fms installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=fms Demo installer\n"
     else:
       line="SetupWindowTitle=fms installer\n"
